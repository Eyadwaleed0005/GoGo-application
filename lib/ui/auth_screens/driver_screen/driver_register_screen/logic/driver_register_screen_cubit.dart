...
class DriverRegisterScreenCubit extends Cubit<DriverRegisterScreenState> {
  ...
  DriverRegisterScreenCubit(this._authRepository) : super(DriverRegisterInitial());
  ...
  Future<void> registerDriver() async {
    ...
    try {
  final UserDriverResponseModel response = await _authRepository.register(model);
  ...
  await SecureStorageHelper.savedata(key: SecureStorageKeys.password, value: passwordController.text);
